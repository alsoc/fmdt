...
namespace ftr_lzi {
    ...
    namespace sck {
        enum class zinit : size_t { in_out_labels, in_RoIs_xmin, in_RoIs_xmax, in_RoIs_ymin, in_RoIs_ymax, in_n_RoIs,
                                    in_fake, status };
    }
}
...
protected:
    ...
    void deep_copy(const Features_labels_zero_init &m);
};
