...
aff3ct::runtime::Task& Features_merger_CCL_HI_v3::operator[](const ftr_mrg::tsk t) {
    return aff3ct::module::Module::operator[]((size_t)t);
}

aff3ct::runtime::Socket& Features_merger_CCL_HI_v3::operator[](const ftr_mrg::sck::merge s) {
