...
class Features_merger_CCL_HI_v2 : public spu::module::Stateful {
protected:
...
public:
    ...
    inline spu::runtime::Task& operator[](const ftr_mrg2::tsk t);
    inline spu::runtime::Socket& operator[](const ftr_mrg2::sck::merge s);
    inline spu::runtime::Socket& operator[](const std::string &tsk_sck);
};

#include "fmdt/spu/Features/Features_merger_CCL_HI_v2.hxx"
