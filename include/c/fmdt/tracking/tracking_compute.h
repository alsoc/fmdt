 ...
 * @param RoIs_a Array of semi-major axis (ellipse). If NULL, not used.
 * @param RoIs_b Array of semi-minor axis (ellipse). If NULL, not used.
 ...
 *                          ignored. `RoIs_a` and `RoIs_b` can't be NULL.
 */
