...
namespace trk {
    ...
    namespace sck {
        enum class perform : size_t { in_frame, in_ROI0_error, in_ROI0_next_id, in_ROI1_id, in_ROI1_xmin, in_ROI1_xmax,
                                      in_ROI1_ymin, in_ROI1_ymax, in_ROI1_x, in_ROI1_y, in_ROI1_prev_id,
