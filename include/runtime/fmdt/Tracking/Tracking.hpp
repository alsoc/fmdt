...
namespace trk {
    ...
    namespace sck {
        enum class perform : size_t { in_frame, in_ROI0_id, in_ROI0_xmin, in_ROI0_xmax, in_ROI0_ymin, in_ROI0_ymax,
                                      in_ROI0_x, in_ROI0_y, in_ROI0_error, in_ROI0_next_id, in_ROI0_magnitude,
                                      in_n_ROI0, in_ROI1_id, in_ROI1_xmin, in_ROI1_xmax, in_ROI1_ymin, in_ROI1_ymax,
                                      in_ROI1_x, in_ROI1_y, in_ROI1_prev_id, in_ROI1_magnitude, in_n_ROI1, in_theta,
                                      in_tx, in_ty, in_mean_error, in_std_deviation, out_track_id, out_track_begin,
