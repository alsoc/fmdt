...
namespace trk {
    ...
    namespace sck {
        enum class perform : size_t { in_frame, in_ROI0_id, in_ROI0_xmin, in_ROI0_xmax, in_ROI0_ymin, in_ROI0_ymax,
                                      in_ROI0_x, in_ROI0_y, in_ROI0_error, in_ROI0_time, in_ROI0_time_motion,
                                      in_ROI0_prev_id, in_ROI0_next_id, in_ROI0_is_extrapolated, in_n_ROI0, in_ROI1_id,
                                      ...
                                      in_std_deviation, out_ROI1_time, out_ROI1_time_motion, out_ROI1_is_extrapolated,
                                      out_track_id, out_track_begin, out_track_end, out_track_extrapol_x,
                                      out_track_extrapol_y, out_track_state, out_track_obj_type,
