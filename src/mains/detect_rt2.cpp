...
int main(int argc, char** argv) {
    ...
    Features_merger_CCL_HI merger0(i0, i1, j0, j1, b, p_mrp_s_min, p_mrp_s_max, p_ccl_hyst_hi, no_labels_zeros_init,
    ...
    Features_merger_CCL_HI merger1(i0, i1, j0, j1, b, p_mrp_s_min, p_mrp_s_max, p_ccl_hyst_hi, no_labels_zeros_init,
                                   MAX_ROI_SIZE_BEFORE_SHRINK, MAX_ROI_SIZE);
    ...
    merger0[ftr_mrg::sck::merge_v3::in_labels] = lsl0[ccl::sck::apply::out_labels];
    // merger0[ftr_mrg::sck::merge_v2::in_img_HI] = threshold_max0[thr::sck::apply::out_img];
    merger0[ftr_mrg::sck::merge_v3::in_img] = video[vid2::sck::generate::out_img0];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_id] = extractor0[ftr_ext::sck::extract::out_RoIs_id];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_xmin] = extractor0[ftr_ext::sck::extract::out_RoIs_xmin];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_xmax] = extractor0[ftr_ext::sck::extract::out_RoIs_xmax];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_ymin] = extractor0[ftr_ext::sck::extract::out_RoIs_ymin];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_ymax] = extractor0[ftr_ext::sck::extract::out_RoIs_ymax];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_S] = extractor0[ftr_ext::sck::extract::out_RoIs_S];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_Sx] = extractor0[ftr_ext::sck::extract::out_RoIs_Sx];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_Sy] = extractor0[ftr_ext::sck::extract::out_RoIs_Sy];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_x] = extractor0[ftr_ext::sck::extract::out_RoIs_x];
    merger0[ftr_mrg::sck::merge_v3::in_RoIs_y] = extractor0[ftr_ext::sck::extract::out_RoIs_y];
    merger0[ftr_mrg::sck::merge_v3::in_n_RoIs] = lsl0[ccl::sck::apply::out_n_RoIs];

    merger1[ftr_mrg::sck::merge_v3::in_labels] = lsl1[ccl::sck::apply::out_labels];
    // merger1[ftr_mrg::sck::merge_v2::in_img_HI] = threshold_max1[thr::sck::apply::out_img];
    merger1[ftr_mrg::sck::merge_v3::in_img] = video[vid2::sck::generate::out_img1];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_id] = extractor1[ftr_ext::sck::extract::out_RoIs_id];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_xmin] = extractor1[ftr_ext::sck::extract::out_RoIs_xmin];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_xmax] = extractor1[ftr_ext::sck::extract::out_RoIs_xmax];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_ymin] = extractor1[ftr_ext::sck::extract::out_RoIs_ymin];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_ymax] = extractor1[ftr_ext::sck::extract::out_RoIs_ymax];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_S] = extractor1[ftr_ext::sck::extract::out_RoIs_S];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_Sx] = extractor1[ftr_ext::sck::extract::out_RoIs_Sx];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_Sy] = extractor1[ftr_ext::sck::extract::out_RoIs_Sy];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_x] = extractor1[ftr_ext::sck::extract::out_RoIs_x];
    merger1[ftr_mrg::sck::merge_v3::in_RoIs_y] = extractor1[ftr_ext::sck::extract::out_RoIs_y];
    merger1[ftr_mrg::sck::merge_v3::in_n_RoIs] = lsl1[ccl::sck::apply::out_n_RoIs];

    // Step 3.5 : calcul de la magnitude pour chaque RoI
    magnitude0[ftr_mgn::sck::compute::in_img] = video[vid2::sck::generate::out_img0];
    magnitude0[ftr_mgn::sck::compute::in_labels] = merger0[ftr_mrg::sck::merge_v3::out_labels];
    magnitude0[ftr_mgn::sck::compute::in_RoIs_xmin] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_xmin];
    magnitude0[ftr_mgn::sck::compute::in_RoIs_xmax] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_xmax];
    magnitude0[ftr_mgn::sck::compute::in_RoIs_ymin] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_ymin];
    magnitude0[ftr_mgn::sck::compute::in_RoIs_ymax] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_ymax];
    magnitude0[ftr_mgn::sck::compute::in_RoIs_S] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_S];
    magnitude0[ftr_mgn::sck::compute::in_n_RoIs] = merger0[ftr_mrg::sck::merge_v3::out_n_RoIs];

    magnitude1[ftr_mgn::sck::compute::in_img] = video[vid2::sck::generate::out_img1];
    magnitude1[ftr_mgn::sck::compute::in_labels] = merger1[ftr_mrg::sck::merge_v3::out_labels];
    magnitude1[ftr_mgn::sck::compute::in_RoIs_xmin] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_xmin];
    magnitude1[ftr_mgn::sck::compute::in_RoIs_xmax] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_xmax];
    magnitude1[ftr_mgn::sck::compute::in_RoIs_ymin] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_ymin];
    magnitude1[ftr_mgn::sck::compute::in_RoIs_ymax] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_ymax];
    magnitude1[ftr_mgn::sck::compute::in_RoIs_S] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_S];
    magnitude1[ftr_mgn::sck::compute::in_n_RoIs] = merger1[ftr_mrg::sck::merge_v3::out_n_RoIs];

    // Step 4 : mise en correspondance
    matcher[knn::sck::match::in_RoIs0_id] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_id];
    matcher[knn::sck::match::in_RoIs0_S] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_S];
    matcher[knn::sck::match::in_RoIs0_x] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_x];
    matcher[knn::sck::match::in_RoIs0_y] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_y];
    matcher[knn::sck::match::in_n_RoIs0] = merger0[ftr_mrg::sck::merge_v3::out_n_RoIs];
    matcher[knn::sck::match::in_RoIs1_id] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_id];
    matcher[knn::sck::match::in_RoIs1_S] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_S];
    matcher[knn::sck::match::in_RoIs1_x] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_x];
    matcher[knn::sck::match::in_RoIs1_y] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_y];
    matcher[knn::sck::match::in_n_RoIs1] = merger1[ftr_mrg::sck::merge_v3::out_n_RoIs];

    // Step 5 : recalage
    motion[mtn::sck::compute::in_RoIs0_x] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_x];
    motion[mtn::sck::compute::in_RoIs0_y] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_y];
    motion[mtn::sck::compute::in_RoIs1_x] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_x];
    motion[mtn::sck::compute::in_RoIs1_y] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_y];
    motion[mtn::sck::compute::in_RoIs1_prev_id] = matcher[knn::sck::match::out_RoIs1_prev_id];
    motion[mtn::sck::compute::in_n_RoIs1] = merger1[ftr_mrg::sck::merge_v3::out_n_RoIs];

    // Step 6 : tracking
    tracking[trk::sck::perform::in_frame] = video[vid2::sck::generate::out_frame];
    tracking[trk::sck::perform::in_RoIs_id] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_id];
    tracking[trk::sck::perform::in_RoIs_xmin] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_xmin];
    tracking[trk::sck::perform::in_RoIs_xmax] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_xmax];
    tracking[trk::sck::perform::in_RoIs_ymin] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_ymin];
    tracking[trk::sck::perform::in_RoIs_ymax] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_ymax];
    tracking[trk::sck::perform::in_RoIs_S] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_S];
    tracking[trk::sck::perform::in_RoIs_x] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_x];
    tracking[trk::sck::perform::in_RoIs_y] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_y];
    ...
    tracking[trk::sck::perform::in_n_RoIs] = merger1[ftr_mrg::sck::merge_v3::out_n_RoIs];
    tracking[trk::sck::perform::in_motion_est] = motion[mtn::sck::compute::out_motion_est2];

    if (p_ccl_fra_path) {
        (*log_frame)[lgr_fra::sck::write::in_labels] = merger1[ftr_mrg::sck::merge_v3::out_labels];
        (*log_frame)[lgr_fra::sck::write::in_RoIs_id] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_id];
        (*log_frame)[lgr_fra::sck::write::in_RoIs_xmin] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_xmin];
        (*log_frame)[lgr_fra::sck::write::in_RoIs_xmax] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_xmax];
        (*log_frame)[lgr_fra::sck::write::in_RoIs_ymin] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_ymin];
        (*log_frame)[lgr_fra::sck::write::in_RoIs_ymax] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_ymax];
        (*log_frame)[lgr_fra::sck::write::in_n_RoIs] = merger1[ftr_mrg::sck::merge_v3::out_n_RoIs];
    }

    if (p_log_path) {
        log_RoIs[lgr_roi::sck::write::in_RoIs0_id] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_id];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_xmin] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_xmin];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_xmax] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_xmax];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_ymin] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_ymin];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_ymax] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_ymax];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_S] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_S];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_Sx] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_Sx];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_Sy] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_Sy];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_x] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_x];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_y] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_y];
        log_RoIs[lgr_roi::sck::write::in_RoIs0_magnitude] = magnitude0[ftr_mgn::sck::compute::out_RoIs_magnitude];
        log_RoIs[lgr_roi::sck::write::in_n_RoIs0] = merger0[ftr_mrg::sck::merge_v3::out_n_RoIs];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_id] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_id];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_xmin] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_xmin];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_xmax] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_xmax];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_ymin] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_ymin];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_ymax] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_ymax];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_S] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_S];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_Sx] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_Sx];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_Sy] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_Sy];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_x] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_x];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_y] = merger1[ftr_mrg::sck::merge_v3::out_RoIs_y];
        log_RoIs[lgr_roi::sck::write::in_RoIs1_magnitude] = magnitude1[ftr_mgn::sck::compute::out_RoIs_magnitude];
        log_RoIs[lgr_roi::sck::write::in_n_RoIs1] = merger1[ftr_mrg::sck::merge_v3::out_n_RoIs];
        ...
        log_kNN[lgr_knn::sck::write::in_RoIs0_id] = merger0[ftr_mrg::sck::merge_v3::out_RoIs_id];
        log_kNN[lgr_knn::sck::write::in_RoIs0_next_id] = matcher[knn::sck::match::out_RoIs0_next_id];
        log_kNN[lgr_knn::sck::write::in_n_RoIs0] = merger0[ftr_mrg::sck::merge_v3::out_n_RoIs];
        ...
        log_kNN[lgr_knn::sck::write::in_n_RoIs1] = merger1[ftr_mrg::sck::merge_v3::out_n_RoIs];
    ...
    { // pipeline stage 0
      ...
      std::make_tuple<std::vector<aff3ct::runtime::Task*>, std::vector<aff3ct::runtime::Task*>,
        ...
        { &merger0[ftr_mrg::tsk::merge_v3], &merger1[ftr_mrg::tsk::merge_v3], },
        { } ),
      // pipeline stage 2
      std::make_tuple<std::vector<aff3ct::runtime::Task*>, std::vector<aff3ct::runtime::Task*>,
                      std::vector<aff3ct::runtime::Task*>>(
