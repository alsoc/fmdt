...
int main(int argc, char** argv) {
    ...
    merger[ftr_mrg::sck::merge::in_img] = video[vid::sck::generate::out_img];
    ...
    if (p_ccl_fra_path) {
        ...
        (*log_frame)[lgr_fra::sck::write::in_RoIs_xmin] = merger[ftr_mrg::sck::merge::out_RoIs_xmin];
    ...
    if (!p_out_probes) {
        ...
        { // pipeline stage 1
          ...
          std::make_tuple<std::vector<aff3ct::runtime::Task*>, std::vector<aff3ct::runtime::Task*>,
                          std::vector<aff3ct::runtime::Task*>>(
            { &threshold_min[thr::tsk::apply], /* &threshold_max[thr::tsk::apply], */ &merger[ftr_mrg::tsk::merge],
        ...
        { // pipeline stage 1
          ...
          std::make_tuple<std::vector<aff3ct::runtime::Task*>, std::vector<aff3ct::runtime::Task*>,
            ...
            { &(*ts_s2b)("exec"), &threshold_min[thr::tsk::apply], /* &threshold_max[thr::tsk::apply], */
              &merger[ftr_mrg::tsk::merge], &magnitude[ftr_mgn::tsk::compute], &(*ts_s2e)("exec") },
            { &merger[ftr_mrg::tsk::merge], &magnitude[ftr_mgn::tsk::compute] },
