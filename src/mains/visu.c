...
int main(int argc, char** argv) {
    ...
    video_reader_t* video = video_reader_init(p_vid_in_path, p_vid_in_start, p_vid_in_stop, 0, 0, p_vid_in_threads, &i0,
                                              &i1, &j0, &j1);
    ...
    size_t n_threads = 4;
    video_writer_t* video_writer = video_writer_init(p_vid_out_path, p_vid_in_start, n_threads, i1 - i0 + 1,
