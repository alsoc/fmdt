...
: Module(), KNN_path(KNN_path), i0(i0), i1(i1), j0(j0), j1(j1) {
    ...
    this->create_codelet(p, [ps_in_data_nearest, ps_in_data_distances, ps_in_data_conflicts, ps_in_ROI_id, ps_in_ROI_S,
                             ps_in_ROI_dx, ps_in_ROI_dy, ps_in_ROI_error, ps_in_ROI_next_id, ps_in_n_ROI,
                             ps_in_n_conflicts, ps_in_frame]
