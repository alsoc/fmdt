...
: Module(), ROI_path(ROI_path) {
    ...
    auto ps_in_ROI1_time = this->template create_socket_in<int32_t>(p, "in_ROI1_time", max_ROI_size);
    auto ps_in_ROI1_time_motion = this->template create_socket_in<int32_t>(p, "in_ROI1_time_motion", max_ROI_size);
    ...
    this->create_codelet(p, [ps_in_ROI0_id, ps_in_ROI0_xmin, ps_in_ROI0_xmax, ps_in_ROI0_ymin, ps_in_ROI0_ymax,
                             ...
                             ps_in_ROI0_time, ps_in_ROI0_time_motion, ps_in_n_ROI0, ps_in_ROI1_id, ps_in_ROI1_xmin,
                             ps_in_ROI1_xmax, ps_in_ROI1_ymin, ps_in_ROI1_ymax, ps_in_ROI1_S, ps_in_ROI1_Sx,
        ...
        if (frame && !lgr_roi.ROI_path.empty()) {
            char file_path[256];
            sprintf(file_path, "%s/%05u_%05u.txt", lgr_roi.ROI_path.c_str(), frame -1, frame);
            ...
            _features_ROI0_ROI1_write(file, frame,
                                      ...
                                      *static_cast<const uint32_t*>(t[ps_in_n_ROI0].get_dataptr()),
                                      ...
                                      static_cast<const int32_t*>(t[ps_in_ROI1_time].get_dataptr()),
                                      static_cast<const int32_t*>(t[ps_in_ROI1_time_motion].get_dataptr()),
