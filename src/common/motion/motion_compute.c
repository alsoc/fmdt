...
void _motion_rigid_registration_corrected(const RoI_basic_t* RoIs0_basic, const RoI_basic_t* RoIs1_basic,
                                          ...
                                          const size_t n_RoIs1, tmat3x3_t* tmat, float mean_error,
                                          float std_deviation) {
    ...
    float tx = xpg - cos_theta * xg + sin_theta * yg;
    float ty = ypg - sin_theta * xg - cos_theta * yg;
...
void _motion_rigid_registration(const RoI_basic_t* RoIs0_basic, const RoI_basic_t* RoIs1_basic,
                                const RoI_asso_t* RoIs1_asso, const size_t n_RoIs1, tmat3x3_t* tmat) {
    _motion_rigid_registration_corrected(RoIs0_basic, RoIs1_basic, RoIs1_asso, NULL, n_RoIs1, tmat, 0.f, 0.f);
}
...
void _motion_extraction(const RoI_basic_t* RoIs0_basic, const RoI_basic_t* RoIs1_basic, const RoI_asso_t* RoIs1_asso,
                        RoI_motion_t* RoIs1_motion, const size_t n_RoIs1, tmat3x3_t* tmat) {
    for (size_t i = 0; i < n_RoIs1; i++) {
        int cc0 = RoIs1_asso[i].prev_id;
        if (cc0) {
            // coordonees du point dans l'image I+1
            float cc1_x = RoIs1_basic[i].x;
            float cc1_y = RoIs1_basic[i].y;

            // calcul de (x,y) pour l'image I
            hcoord_t up_cc0_pos = motion_update_pos(tmat, RoIs0_basic[cc0 - 1].x, RoIs0_basic[cc0 - 1].y);
            float dx = cc1_x - up_cc0_pos.x;
            float dy = cc1_y - up_cc0_pos.y;
...
void motion_compute(const RoI_basic_t* RoIs0_basic, const RoI_basic_t* RoIs1_basic, const RoI_asso_t* RoIs1_asso,
    ...
    _motion_rigid_registration(RoIs0_basic, RoIs1_basic, RoIs1_asso, n_RoIs1, &motion_est1->tmat);
    _motion_extraction(RoIs0_basic, RoIs1_basic, RoIs1_asso, RoIs1_motion, n_RoIs1, &motion_est1->tmat);
    ...
    _motion_rigid_registration_corrected(RoIs0_basic, RoIs1_basic, RoIs1_asso, RoIs1_motion, n_RoIs1,
                                         &motion_est2->tmat, motion_est1->mean_error,
                                         motion_est1->std_deviation);
    _motion_extraction(RoIs0_basic, RoIs1_basic, RoIs1_asso, RoIs1_motion, n_RoIs1, &motion_est2->tmat);
...
void motion_compute_without_registration(const RoI_basic_t* RoIs0_basic, const RoI_basic_t* RoIs1_basic,
    ...
    motion_init_tmat3x3_identity(&motion_est1->tmat);
    motion_est1->std_deviation = 0;
    motion_est1->mean_error = 0;
    motion_init_tmat3x3_identity(&motion_est2->tmat);
