...
char g_fmdt_sha1[256] = "07d263ccc42d074625db6ec6279ccd68bd8e5ef4";
char g_fmdt_version[256] = "v1.0.0-1-g07d263c";
unsigned g_fmdt_version_major = 1;
unsigned g_fmdt_version_minor = 0;
unsigned g_fmdt_version_patch = 0;
unsigned g_fmdt_build = 1;
