...
for Exe in 'fmdt-common-obj' 'fmdt-detect-rt-common-obj' 'fmdt-detect-exe' 'fmdt-detect-rt-pip-exe' 'fmdt-detect-rt-seq-exe'; do
    ...
    rc=$?; if [[ $rc != 0 ]]; then exit $rc; fi
    lcov --remove code_coverage_files/${Exe}2.info "*/usr*" "*lib/*" "src/common/version.c" --output-file ${WD}/code_coverage_files/${Exe}_clean.info
done
